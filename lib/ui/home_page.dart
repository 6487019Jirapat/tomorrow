...
import '../auth.dart';
import '../screens/items/detail_page_sunny_items.dart';
                ...
                children: <Widget>[
                          ...
                          onPressed: () {
                            if (humidity >= 100) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => HomePage_raining()),
                              );
                            }
                            if (temperature <= 27) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => HomePage_winter()),
                              );
                            } else if (temperature > 27) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => HomePage_sunny()),
                              );
                            }
                          },
                          child: Container(
                        ...
                        if (humidity >= 100) {
                            ...
                            if (temperature <= 27) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Items_winter()),
                              );
                            } else if (temperature > 27) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Items_sunny()),
                              );
                            }
                          },
                          child: Center(
                  ...
                  GestureDetector(
                        onTap: () => Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Register_Login()
                            )), 
                        child: Text(
                          'Sign-Out',
                          style: TextStyle(
